...
if is_main
    # Model 0: Base only
    formula_0 = @formula(is_choice ~ base_sim + (1|triplet_id) + (1|subject_id))
    ...
    formula_1 = @formula(is_choice ~ base_sim + ablation_sim + (1|triplet_id) + (1|subject_id))
    ...
    formula_2 = @formula(is_choice ~ base_sim + ablation_sim + main_sim + (1|triplet_id) + (1|subject_id))
